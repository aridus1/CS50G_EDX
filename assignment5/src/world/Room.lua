...
--Adv: forward declaration for local functions
...
function Room:update(dt)
    ...
    for k, powerup in pairs(self.powerups) do
        ...
        --Adv: trigger collision callback on object
...
function generateSwitch(room)
    ...
    math.random(MAP_RENDER_OFFSET_X + TILE_SIZE, VIRTUAL_WIDTH - TILE_SIZE * 2 - 16),math.random(MAP_RENDER_OFFSET_Y + TILE_SIZE, VIRTUAL_HEIGHT - (VIRTUAL_HEIGHT - MAP_HEIGHT * TILE_SIZE) + MAP_RENDER_OFFSET_Y - TILE_SIZE - 16)
    )
