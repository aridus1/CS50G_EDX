...
--[[
    Adv:    This function is specifically made to piece out the powerups from the
        sprite sheet. For this, we have to piece out the powerups a little more 
        manually, since they are in a awkward position in the sheet.
        They are of the same size though
]]
