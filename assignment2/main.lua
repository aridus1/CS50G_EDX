...
function love.load()
    ...
    gFonts = {
        ['small'] = love.graphics.newFont('fonts/font.ttf', 8), --small font
        ['medium'] = love.graphics.newFont('fonts/font.ttf', 16), --medium font
        ['large'] = love.graphics.newFont('fonts/font.ttf', 32) --large font
    }
    love.graphics.setFont(gFonts['small'])

    -- load up the graphics we'll be using throughout our states
    gTextures = {
        ['background'] = love.graphics.newImage('graphics/background.png'), --background has the screen background
        ['main'] = love.graphics.newImage('graphics/breakout.png'), -- has the bricks, paddles, balls etc.
        ['arrows'] = love.graphics.newImage('graphics/arrows.png'), -- for paddle select screen
        ['hearts'] = love.graphics.newImage('graphics/hearts.png'), -- for health
        ['particle'] = love.graphics.newImage('graphics/particle.png') -- for particle systems
    }
