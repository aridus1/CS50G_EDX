...
public class LevelGenerator : MonoBehaviour {
	...
	//keeps a record of the level we are in
	...
	//Adv: holes  creation. the count is proportional to size
	...
	void Start () {
		...
		//Adv: initialization of hole variables
		holeCount = mazeSize / 10;
		holesCreated = 0;
		//Adv: generating hole coordinates
		holeCoordinates = new Coordinates[holeCount];
		for(int i = 0; i< holeCount; i++)
		{
			int x;
			int z;

			//making sure the hole iisn't under a wall
			do
			{
